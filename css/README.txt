...
To use these stylesheets, rename the files and simpline with the name of your theme.
...
simpline-alpha-default-narrow.css  
...
simpline-alpha-default-normal.css
...
simpline-alpha-default-wide.css
